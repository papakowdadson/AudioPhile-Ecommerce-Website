...
const CartModal = ({onClick}) => {
    ...
    const {items,getItemsCount,addItemToCart,getTotalPrice,removeItem} = cartContext
            ...
            <div className='flex justify-end place-items-end pt-10'>
                <div className='bg-white p-6 rounded-lg shadow-lg w-96 space-y-4 max-h-[500px] overflow-y-auto'>
                    <div className='flex justify-between'>
                            ...
                            <p className='text-body font-medium text-secondary_black_50'>Remove all</p>
                    ...
                    <PrimaryButton label={'Checkout'} onClick={HandleNavigateToCheckout}/>
                </div>
            </div>                   
        </ScreenCap>
    </div>
