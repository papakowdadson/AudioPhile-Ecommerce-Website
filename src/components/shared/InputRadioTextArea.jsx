...
const InputRadioTextArea = ({placeholder,id,field,onChange,checkedValue,name}) => {
  return (
    <div className={`border ${(field==checkedValue)?'border-primary_orange':'border-tertiary_grey'}  p-2 min-w-[288px] rounded-lg hover:border-primary_orange transition-colors duration-300 space-x-2 border-2 `}>
